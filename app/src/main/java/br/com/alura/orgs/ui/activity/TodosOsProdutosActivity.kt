...
import br.com.alura.orgs.databinding.ActivityTodosOsProdutosBinding
...
class TodosOsProdutosActivity : UsuarioActivityBase() {

    private val binding by lazy {
        ActivityTodosOsProdutosBinding.inflate(layoutInflater)
    }
