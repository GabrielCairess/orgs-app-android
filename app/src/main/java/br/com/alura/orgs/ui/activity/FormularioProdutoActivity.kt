...
class FormularioProdutoActivity : UsuarioActivityBase() {
        ...
        lifecycleScope.launch {
            produtoDao.buscaPorId(produtoId).collect {
                it?.let { produtoEncontrado ->
                    ...
                    campoUsuarioId.visibility = verificaSeProdutoTemUsuario(produtoEncontrado)
    ...
    private fun verificaSeProdutoTemUsuario(produtoEncontrado: Produto) =
    ...
    private fun configuraCampoUsuario() {
        lifecycleScope.launch {
            usuarios().map { usuarios -> usuarios.map { it.id } }
                .collect { usuarios ->
